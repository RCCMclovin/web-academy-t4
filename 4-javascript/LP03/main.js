...
// setup objects
const forms = ["Ball", "Square", "Rectangle"];
var objects = []
...
function Poli(x, y, velX, velY, color, size, form) {
  this.x = x;
  this.y = y;
  this.velX = velX;
  this.velY = velY;
  ...
  this.size = size;
  this.form = form;
  if(this.form === "Rectangle") this.width = random(10, 20)
  this.invincibilityFrames = 0;
}

Poli.prototype.draw = function () {
  ctx.beginPath();
...
Poli.prototype.update = function () {
...
Poli.prototype.collisionDetect = function () {
